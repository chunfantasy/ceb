...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="JavaScript" type="text/javascript" src="/CEB/image/global.js"></script>
        <script language="JavaScript" type="text/javascript" src="/CEB/image/common.js"></script>
  ...
  <tbody>
    <tr>
      ...
      <td width="1%"><img src="/CEB/image/header-right.gif" alt="" height="57" border="0"></td></tr>
  </tbody>
</table>
<br>
<div id="jive-flatpage">
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      <tr valign="top">
        <td width="99%"><p class="jive-breadcrumbs"> 首页 &#187;武汉理工大学&nbsp;|&nbsp;经济学院&nbsp;|&nbsp;电子商务协会|&nbsp;技术论坛 : 初学java遇一难题 </p>
         </td>
...
<s:debug></s:debug>
 ...
 <table border="0" cellpadding="0" cellspacing="0" width="930" height="61">
    <tbody>
       <tr>
          <td class="jive-icon"><img src="/CEB/image/reply-16x16.gif" alt="回复本主题" border="0"  width="16">&nbsp;&nbsp;&nbsp;&nbsp;回复本主题</td>
        ...
        <td width="99%"><div id="jive-message-holder">
            <div class="jive-message-list">
              <div class="jive-table">
                ...
                <form action="web/bbsPost?currentPage=1" method="post">
                		<input type="hidden" name="bbs.pname" value="<s:property value="#session.user" />"/>
                		<input type="hidden" name="bbs.rootid" />
                		<p class="jive-breadcrumbs">主题：<input type="text" name="bbs.title"  size="50"  /></p>
                		<textarea name="bbs.cont" rows="60" cols="60"></textarea>
                		<input type="hidden" name="bbs.pdate" value="<%=getTime() %>" />
                		<%=getTime() %>
                		<input type="hidden" name="bbs.isleaf" value="0"/>
                		<br>
